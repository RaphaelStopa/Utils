...
public class CNPJ {
    ...
    private static final String MASK_CNPJ = "([0-9]{2})([0-9]{3})([0-9]{3})([0-9]{4})([0-9]{2})";
    private static final String MASK_CPF  = "([0-9]{3})([0-9]{3})([0-9]{3})([0-9]{2})";

    public static boolean isCNPJFormat(String cnpj) {
     ...
     * @return
     */
    public static boolean isDocumentFormat(String document) {
        return isCNPJFormat(document) || isCPFFormat(document);
    }
    ...
    public static String formatCNPJ(String cnpj) {
        ...
        return (cnpj.replaceAll(MASK_CNPJ,"$1.$2.$3/$4-$5"));
    }
    ...
    public static void main(String[] args) {
        CNPJ gerador = new CNPJ();

        List<String> nha = new ArrayList<>();


        for(int i = 1; i <= 1000; i++) {
            String rg = gerador.cnpj(true);
            nha.add(rg);
        }
